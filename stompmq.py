...
:author: Marc Bertens-Nguyen <m.bertens@pe2mbs.nl>
:license: GPLv2

:created on 2018-10-17 22:18
:last modified by:   Marc Bertens-Nguyen
...
logger = logging.getLogger( 'flask.flask_stomp' )
