...
insert into WA_USERS ( D_USER_NAME, D_PASSWORD, D_FIRST_NAME, D_MIDDLE_NAME, D_LAST_NAME, D_ROLE_ID )
       values ( 'mbertens', '5701mb', 'Marc', '', 'Bertens-Nguyen', 1 );
insert into WA_USERS ( D_USER_NAME, D_PASSWORD, D_FIRST_NAME, D_MIDDLE_NAME, D_LAST_NAME, D_ROLE_ID )
       values ( 'erijerse', '123456', 'Ernst', '', 'Rijerse', 1 );
