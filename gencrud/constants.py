...
C_BASE                  = 'base'
C_PYTHON                = 'python'
C_EXT_MODELS            = 'ext-models'
C_HELP_PAGES            = 'help-pages'
C_COMMON                = 'common'
...
C_TEXTAREA              = 'textarea'
C_EDITOR                = 'editor'
C_MONACO_EDITOR         = 'monaco'
C_EDITOR_ACTION_BAR     = 'actionbar'
C_EDITOR_LANGUAGE       = 'language'
C_EDITOR_MINIMAP        = 'minimap'
C_EDITOR_THEME          = 'theme'
C_FUNCTION              = 'function'
C_HEIGHT                = 'height'
C_TOOLTIP               = 'tooltip'
C_NUMBER                = 'number'
...
C_GENERATE_EXT_MODELS   = 'generate-ext-models'
C_GENERATE_HELP_PAGES   = 'generate-help-pages'
...
C_COPY_SUPPORT_FILES    = 'copy-support-files'
C_USE_LOCAL_TEMPLATE    = 'use-local-template'
C_USE_PRETTIER          = 'use-prettier'
C_USE_YAPF              = 'use-yapf'
C_PRETTIER_STYLE        = 'prettier-style'
C_YAPF_STYLE            = 'yapf-style'