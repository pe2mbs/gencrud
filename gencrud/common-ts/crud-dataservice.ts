...
export class CrudDataService<T>
{
    ...
    public getSelectListSimple( value: string, label: string, sorton: string, initial: any = null, final: any = null ): Observable<PytSelectList[]>
    {
        const params = new HttpParams().set('label', label ).set('value', value )
        if ( sorton != null )
        {
            params.set( 'sorton', sorton );
        }
        if ( initial != null )
        {
    ...
    public getSelectList( value: string, label: string, sorton: string, initial: any = null, final: any = null ): Observable<PytSelectList[]>
    {
        const params = new HttpParams().set('label', label ).set('value', value );
        if ( sorton != null )
        {
    ...
    public getSelectionList( value: string, label: string, sorton: string, initial: any = null, final: any = null ): Observable<Array<string>>
    {
        const params = new HttpParams().set('label', label ).set('value', value );
        if ( sorton != null )
        {
