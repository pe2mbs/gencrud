...
@Component({
     ...
     *ngIf="buttonPosition == 'left' || buttonPosition == 'both'"
     [icon]="iconLeft"
     [disabled]="disableEdit"
     [dialog]="dialog"
     [self]="contextObject"
     [func]="funcToEvaluateLeft"
    ...
    <app-edit-table-button 
     [id]="formControlName" [value]="serviceItem"
     [serviceName]="serviceName"
     *ngIf="buttonPosition == 'right' || buttonPosition == 'both'"
     [icon]="iconRight"
     [disabled]="disableEdit"
     [dialog]="dialog"
     [self]="contextObject"
     [func]="funcToEvaluateRight"
     (editButtonClicked)="onEditButtonClick( $event )"
     fxFlex="60px"
     ></app-edit-table-button>
     </div>`
...
export class GcBaseComponent extends GcSubscribers implements ControlValueAccessor, OnChanges, OnInit, AfterViewInit
{
    ...
    @Input()                funcToEvaluateLeft: string;
    @Input()                funcToEvaluateRight: string;
