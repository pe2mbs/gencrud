...
@Component( {
    ...
    template: `
    <app-base-input [template]="ref" [serviceItem]="serviceItem" [iconLeft]="iconLeft" [iconRight]="iconRight" [buttonPosition]="buttonPosition"
    [funcToEvaluateLeft]="funcToEvaluateLeft" [funcToEvaluateRight]="funcToEvaluateRight" [contextObject]="contextObject"
    [disableEdit]="disableEdit" [serviceName]="serviceName">
    <ng-template #ref>
    <div class="form">
