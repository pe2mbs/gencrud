...
template_list   = [ 'templates/angular/addedit.dialog.html.templ',
...
setup(
    ...
    description = 'A code templating engine for CRUD handling',  # Optional
    ...
    url = 'https://www.pe2mbs.nl/python/pytemplate',  # Optional
    ...
    classifiers = [  # Optional
        ...
        'Topic :: Software Development :: Build Tools :: Typescript',
    ...
    keywords='crud templating angular development',  # Optional
    ...
    project_urls = {  # Optional
        'Bug Reports':  'https://www.pe2mbs.nl/python/pytemplate/issues',
        'Say Thanks!':  'https://www.pe2mbs.nl/python/pytemplate/saythanks',
        'Source':       'https://gitlab.pe2mbs.nl/angular/pytemplate/',
        'Source Public':'https://github.com/pe2mbs/pytemplate/',
    },
)
